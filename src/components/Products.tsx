...
const launched: Product[] = [
  {
    ...
    status: "Launched",
    desc: "Markdown publishing that actually looks good. Paste from any AI, import PDFs and docs, or capture straight from ChatGPT and Claude. Edit in WYSIWYG, share with one link. Available on web, Mac, VS Code, CLI, Chrome, and as an MCP server.",
    descKo: "마크다운을 제대로 보여주는 퍼블리싱 도구. AI 출력을 붙여넣거나, PDF·문서를 임포트하거나, ChatGPT·Claude에서 바로 캡처한다. WYSIWYG로 편집하고 링크 하나로 공유. 웹, Mac 앱, VS Code, CLI, Chrome 확장, MCP 서버까지 지원한다.",
