...
const launched: Product[] = [
  {
    ...
    status: "Launched",
    desc: "AI writes great answers — then they disappear when you close the tab. mdfy.cc captures them, renders them beautifully, and gives you a permanent link to share. Paste markdown, import PDFs and docs, or grab directly from ChatGPT and Claude. Edit inline, share instantly. Works on web, Mac, VS Code, CLI, Chrome, and as an MCP server.",
    descKo: "AI가 좋은 답을 써줘도 탭을 닫으면 사라진다. mdfy.cc는 그 내용을 캡처하고, 보기 좋게 렌더링하고, 영구 링크로 공유할 수 있게 해준다. 마크다운을 붙여넣거나, PDF·문서를 임포트하거나, ChatGPT·Claude에서 바로 가져온다. 그 자리에서 편집하고 바로 공유. 웹, Mac 앱, VS Code, CLI, Chrome 확장, MCP 서버에서 쓸 수 있다.",
