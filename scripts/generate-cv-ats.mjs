...
const content = {
  en: {
    ...
    raymindDesc: 'An independent product studio building consumer apps, developer tools, and AI engines. mdfy.app, pastlife.app, jolong.ai, screenstyler.ai, and ddalggak.ai are live, with more in development.',
  ...
  ko: {
    ...
    raymindDesc: '소비자 앱, 개발자 도구, AI 엔진을 자체 기획·개발·출시하는 독립 프로덕트 스튜디오. mdfy.app, pastlife.app, jolong.ai, screenstyler.ai, ddalggak.ai가 출시되어 운영 중이며, 추가 제품을 개발하고 있다.',
