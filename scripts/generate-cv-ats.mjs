...
const content = {
  en: {
    ...
    summary: "Product and design leader with over 15 years of experience across the UK, Korea, and Saudi Arabia. Enterprise AI platforms, VR, consumer products — I have built the teams, shipped the products, and run the organizations. Currently building Raymind.AI, an independent product studio where I make and ship my own products.",
    sNow: 'Now', sExp: 'Experience', sEarlier: 'Earlier Experience', sExpertise: 'Core Expertise', sEdu: 'Education', sLang: 'Language',
    raymindDesc: 'An independent product studio building consumer apps, developer tools, and AI engines. memory.wiki, pastlife.app, jolong.ai, screenstyler.ai, and ddalggak.ai are live, with more in development.',
  ...
  ko: {
    lang: 'ko',
    title: 'AI Product & Experience Executive',
    summary: '영국, 한국, 사우디아라비아에서 제품과 디자인 조직을 이끌어 왔다. 대기업 AI 플랫폼, VR, 소비자 제품까지 — 팀을 만들고, 제품을 출시하고, 조직을 키워왔다. 현재는 직접 제품을 만들어 출시하는 독립 스튜디오 Raymind.AI를 운영하고 있다.',
    sNow: '현재', sExp: '경력', sEarlier: '이전 경력', sExpertise: '핵심 역량', sEdu: '학력', sLang: '언어',
    raymindDesc: '소비자 앱, 개발자 도구, AI 엔진을 자체 기획·개발·출시하는 독립 프로덕트 스튜디오. memory.wiki, pastlife.app, jolong.ai, screenstyler.ai, ddalggak.ai가 출시되어 운영 중이며, 추가 제품을 개발하고 있다.',
